...
{   
    ...
    public function loginAuthentication(Request $request){
       ...
       $validator = Validator::make($request->all(), [
        ...
        if($validator->fails()){
        	...
        	// DB::setDefaultConnection('kia_activity');
            ...
            if(!empty($currentUser)){
                if($currentUser->active_status == 'active'){
                    ...
                    $user = array(
                        ...
                        'role' => $currentUser->get_role->role_title
                    );
    ...
    public function getProfile(Request $request){
      ...
      $details['user'] = Admin::find(Session::get('user_details')[0]['user_id']);
    ...
    public function logout(Request $request){
        ...
        if(Session::has('user_details')){
            // $user = Admin::find(Session::get('user_details')[0]['user_id']);
