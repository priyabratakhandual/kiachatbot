...
define("CONFIG_URL", "https://demo.inhelpdesk.com");

// user name in CRM
define("CONFIG_NAME", "demo");

// Access Key for given user name (found under "My Preferences")
define("CONFIG_KEY", "9YxpsUxqjl3gwII4");  // TJQuO2tO1Zqci74Z
...
class WebhookDemoController extends Controller
{
    ...
    public function handleActionGenRandomText(array $payload){
    ...
    public function handleActionUpdateTicketDetail(array $payload){
    ...
    public function handleActionGetTicketStatusById(array $payload){
       ...
       $chatId = $payload['chatId'];
        ...
        $ch = curl_init(base_url.'/public/api/demo/fetchTicketByTicketNumber');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        $response = curl_exec($ch);
        curl_close($ch);
    ...
    public function handleActionVerifyDealerForProduct(array $payload){
    ...
    public function handleActionGetTicketsByProduct(array $payload){
    ...
    public function handleActionAnswerQuestion(array $payload){
        ...
        public function handleActionAnswerQuestionTwo(array $payload){
    ...
    public function handleActionGetLastTickets(array $payload){
       ...
       $previousIntent = $payload['fulfillment']['previousIntent'];
        ...
        $ch = curl_init(base_url.'/public/api/demo/fetchTicket');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        $response = curl_exec($ch);
        curl_close($ch);
    ...
    public function handleActionGenerateTicketid(array $payload){
    ...
    public function handleActionLinkFilesWithTicketComment(array $payload){
    ...
    public function handleActionLinkFilesWithTicket(array $payload){
    ...
    public function handleActionVerifyDealerCreateTicket(array $payload){
       ...
       $chatId = $payload['chatId'];
        ...
        $ch = curl_init(base_url.'/public/api/demo/verifyDealer');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        $response = curl_exec($ch);
        curl_close($ch);
    ...
    public function handleActionAddCommentToTicket(array $payload){
    ...
    public function handleActionCreateTicketBotgo(array $payload){
       ...
       $chatId = $payload['chatId'];
        ...
        $ch = curl_init(base_url.'/public/api/demo/createTicket');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
        $response = curl_exec($ch);
        curl_close($ch);
        $res = json_decode($response,true);
            ...
            Log::useDailyFiles(storage_path().'/logs/aditay.log');
            Log::info($res);
    ...
    public function handleActionCategory1(array $payload){
    ...
    public function handleActionCategory2(array $payload){
    ...
    public function handleActionCategory3(array $payload){
