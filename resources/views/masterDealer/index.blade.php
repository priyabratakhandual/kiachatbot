			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Master Dealer Data</h5>
					</div>
					<!-- Breadcrumb -->
{{-- 					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<a href="{{URL::to('goahead/create')}}"><button class="pull-right btn btn-success btn-outline fancy-button btn-0">CREATE G</button></a>
					  <ol class="breadcrumb">
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="dealer_master" class="table table-hover display  pb-30" style="width: 100% !important" >
												<thead>
													<tr>
														<th></th>
														<th>Sr.</th>
