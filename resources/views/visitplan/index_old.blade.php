			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<a href="{{URL::to('visitplan/create')}}"><button class="pull-right btn btn-success btn-outline fancy-button btn-0">CREATE VISIT PLAN</button></a>
					  {{-- <ol class="breadcrumb">
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="visitplan" class="table table-hover display" style="width:100%;" >
												<thead>
													<tr>
														<th></th>
														<th>Region</th>
														...
														<th>location type</th>
														<th>Agenda of visit</th>
														<th>visit planned date</th>
