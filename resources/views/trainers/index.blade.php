			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Trainers</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<a href="{{URL::to('trainers/create')}}"><button class="pull-right btn btn-success btn-outline fancy-button btn-0">Add Trainer</button></a>
					  {{-- <ol class="breadcrumb">
								...
								<div class="panel-body">
									<div class="table-wrap">
										<div class="table-responsive" style="overflow: hidden;">
											<table id="trainers" class="table table-hover display pb-30">
												<thead>
													<tr>
														<th></th>
														<th>Sr.</th>
